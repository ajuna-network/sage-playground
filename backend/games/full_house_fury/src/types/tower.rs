...
impl Tower {
    ...
    pub fn get_boon_and_bane(&self, position: Position) -> Result<(BonusType, MalusType), FuryError> {
        if position > 2 {
    ...
    pub fn set_boons_and_banes(&mut self, position: Position, boon: BonusType, bane: MalusType) -> Result<(), FuryError> {
        if position > 2 {
            return Err(FuryError::InvalidBoonAndBanePosition);
        }
    ...
    fn set_single_boon(&mut self, boon_index: Index, boon_value: bool) -> Result<(), FuryError> {
        ...
        self.single_boons = (self.single_boons & !(1 << boon_index)) | ((boon_value as u32) << boon_index);
        Ok(())
    }
    ...
    fn set_multi_boon(&mut self, boon_index: Index, boon_value: u8) -> Result<(), FuryError> {
        ...
        self.multi_boons = (self.multi_boons & !(3 << boon_index)) | ((boon_value as u32) << boon_index);
        Ok(())
    }
    ...
    fn set_single_bane(&mut self, bane_index: Index, bane_value: bool) -> Result<(), FuryError> {
        ...
        self.single_banes = (self.single_banes & !(1 << bane_index)) | ((bane_value as u32) << bane_index);
        Ok(())
    }
    ...
    fn set_multi_bane(&mut self, bane_index: Index, bane_value: u8) -> Result<(), FuryError> {
        ...
        self.multi_banes = (self.multi_banes & !(3 << bane_index)) | ((bane_value as u32) << bane_index);
        Ok(())
    }
}
